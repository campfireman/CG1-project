#ifndef CgLoadedObj_H
#define CgLoadedObj_H
...
class CgLoadedObj : public CgBaseTriangleMesh
{
...
inline Cg::ObjectType CgLoadedObj::getType() const { return m_type; }
inline unsigned int CgLoadedObj::getID() const { return m_id; }
